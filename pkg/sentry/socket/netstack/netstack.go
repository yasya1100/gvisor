...
var Metrics = tcpip.Stats{
	...
	ARP: tcpip.ARPStats{
		...
		RequestsReceivedKnownTargetAddress:              mustCreateMetric("/netstack/arp/requests_received_known_addr", "Total number of ARP requests received with a known target address."),
		...
		OutgoingRequestWriteErrors:                      mustCreateMetric("/netstack/arp/outgoing_request_write_errors", "Total number of ARP requests which failed to write to a link-layer endpoint."),
		...
		OutgoingReplyWriteErrors:                        mustCreateMetric("/netstack/arp/outgoing_reply_write_errors", "Total number of ARP replies which failed to write to a link-layer endpoint."),
